...
import { COLUMNS } from "./IDChecksCol";
...
const IDChecksTable = () => {
   ...
   const data = useMemo(() => DATA.IDChecks, []);
   ...
   return (
      <>
         <table
            className={`mt-2 mb-3 pricingplantable customer_idcheck bgless_table`}
            {...getTableProps()}>
            <thead>
