...
import MOCK_DATA from './../../../../data/trackingdetails.json';
...
import "./trackingdetailstable.scss";

const TrackingDetailsTable = () => {
    ...
    return (
        <>    
            <table className='mt-2 mb-3 trackingtable' {...getTableProps()}>
                <thead>                    
