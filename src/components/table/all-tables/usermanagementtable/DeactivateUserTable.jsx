...
const DeactivateUserTable = () => {
    ...
    const loadUsers = useCallback(async () => {
        try {            
            const response = await axios.get(`${baseUrl}/admin/users?status=inactive`);
    ...
    const handleDeleteClick = async (rowId) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`http://localhost:3030/activeUsers/${rowId}`);
                loadUsers();
                Swal.fire({
                    title: "Deleted!",
    ...
    const handleActiveUserClick = async (rowId) => {
        try {
            const response = await axios.post(`${baseUrl}/admin/users/bulk-action?action=activate`, [rowId]);
                                ...
                                >
                                    ...
                                    <td>
                                        <TableActionBtnGroup 
                                            ...
                                            activateUser={() => handleActiveUserClick(row.original.id)}
                                            ...
                                            tooltips={{
                                                ...
                                                activateUser: { id: "tooltip-activate", content: "Activate", place: "top" },
...
export default DeactivateUserTable;