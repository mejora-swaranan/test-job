...
const CreateUser = () => {
    ...
    const handleRolesChange = (e) => {
        ...
        const labels = Array.from(checkedBoxes).map(checkbox => checkbox.labels[0].innerText);
    ...
    const handleSubmit = (e) => {
        ...
        if (!email) {
            ...
            if (!emailRegex.test(email)) {
                ...
                isValid = false;
            } else if (activeUsers && activeUsers.some(user => user.email === email)) {
        ...
        axios.post('http://43.204.210.62:9092/api/v1/admin/users', userData)
            .then(response => {
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div className="col-sm-8">
                                <div className="input-group">
                                    <input 
                                        ...
                                        value={name}
                                    />
                                    {nameError && <div className="text-danger small">{nameError}</div>}
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="input-group-wrap">
                                    ...
                                    {passwordError.length > 0 
                                        ? passwordError.map((error, index) => (
                                            <div key={index} className="text-danger small" style={{ display: "block", color: "#ff0000" }}>
                                                <FaInfoCircle /> {error}
                                            </div>
                                        )) 
                                        : passwordValid && <div className="small" style={{ color: "#14bc96" }}><FaCheck /> Password is okay</div>
                                    }
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-8">
                                <div className="input-group">
                                    ...
                                    />
                                    {passwordConfirmError && <div className="text-danger small">{passwordConfirmError}</div>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row mt-4">
                            <div className="col-sm-8 offset-sm-5 d-flex d-sm-block justify-content-center justify-content-sm-start">
                                <button type="button" className="btn btn-red me-2" onClick={handleCancel}>
                                    Cancel
                                </button>
